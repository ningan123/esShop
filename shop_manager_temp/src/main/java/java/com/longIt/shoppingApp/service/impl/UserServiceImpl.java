...
import java.com.longIt.shoppingApp.service.UserServiceI;
...
public class UserServiceImpl implements UserServiceI {
	...
	public void saveUser(User user,HttpServletRequest request) {
		...
		try {
			...
			/*UUID 是指Universally Unique Identifier，翻译为中文是通用唯一识别码，UUID 的目的是让分布式系统中的所有元素都能有
			唯一的识别信息。如此一来，每个人都可以创建不与其它人冲突的 UUID，就不需考虑数据库创建时的名称重复问题。
*/
	...
	/**
	 ** @see UserServiceI#active(String)
	 * 	 * //用户信息激活
	 */
